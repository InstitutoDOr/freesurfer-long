function LobeExtract(dataset,rootfolder,subjrootfolder,POSname,targetpath)
...
save([targetpath dataset '_LobesExtract.mat'],'AvgThickness','TotalArea','SmoothArea','K_ds','K_CHwoB','SmoothArea_ds','SmoothArea_CHwoB')
